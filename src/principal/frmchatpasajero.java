...
public class frmchatpasajero extends javax.swing.JFrame implements Observer {

    public frmchatpasajero() {
        initComponents();
        this.getRootPane().setDefaultButton(this.btnEnviar);
        Chofer s = new Chofer(5000);
        s.addObserver(this);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CHAT DEL PASAJERO");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtTextoEnviar, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        String mensaje = "Pasajero: " + this.txtTextoEnviar.getText() + "\n";
    this.txtTexto.append(mensaje);
    Pasajero c = new Pasajero(6000, mensaje);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CalificacionConductor fr = new CalificacionConductor();
        fr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmchatpasajero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmchatpasajero().setVisible(true);
            }
        });
    }
